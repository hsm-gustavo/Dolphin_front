...
const Login = () => {
  return (
    <div className="flex flex-col justify-center items-center w-6/12 h-5/6 px-5 rounded-3xl text-center bg-white">
      ...
      <form className="flex flex-col">
        ...
        <label
          className="flex flex-row justify-between font-semibold text-left mb-2"
          htmlFor="password"
        >
          Password
        ...
        />
        <p>
          Don't have an account? <Link to={123} className="underline">Sign up</Link>
        </p>
      </form>
    </div>
  )
